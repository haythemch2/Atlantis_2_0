...
/**
 * Represents the parameters for the "doesPlotExist" function.
 */
export type DoesPlotExistParams = {
  x: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"x","type":"uint256"}>
y: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"y","type":"uint256"}>
};

/**
 * Calls the "doesPlotExist" function on the contract.
 * @param options - The options for the doesPlotExist function.
 * @returns The parsed result of the function call.
 * @example
 * ```
 * import { doesPlotExist } from "TODO";
 * 
 * const result = await doesPlotExist({
 *  x: ...,
 *  y: ...,
 * });
 * 
...
/**
 * Represents the parameters for the "getPlotURI" function.
 */
export type GetPlotURIParams = {
  x: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"x","type":"uint256"}>
y: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"y","type":"uint256"}>
};

/**
 * Calls the "getPlotURI" function on the contract.
 * @param options - The options for the getPlotURI function.
 * @returns The parsed result of the function call.
 * @example
 * ```
 * import { getPlotURI } from "TODO";
 * 
 * const result = await getPlotURI({
 *  x: ...,
 *  y: ...,
 * });
 * 
...
/**
 * Represents the parameters for the "tokenIdByCoordinates" function.
 */
export type TokenIdByCoordinatesParams = {
  x: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"x","type":"uint256"}>
y: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"y","type":"uint256"}>
};

/**
 * Calls the "tokenIdByCoordinates" function on the contract.
 * @param options - The options for the tokenIdByCoordinates function.
 * @returns The parsed result of the function call.
 * @example
 * ```
 * import { tokenIdByCoordinates } from "TODO";
 * 
 * const result = await tokenIdByCoordinates({
 *  x: ...,
 *  y: ...,
 * });
 * 
...
/**
 * Represents the parameters for the "mintPlot" function.
 */
export type MintPlotParams = {
  x: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"x","type":"uint256"}>
y: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"y","type":"uint256"}>
fullURI: AbiParameterToPrimitiveType<{"internalType":"string","name":"fullURI","type":"string"}>
};

/**
 * Calls the "mintPlot" function on the contract.
 * @param options - The options for the "mintPlot" function.
 * @returns A prepared transaction object.
 * @example
 * ```
 * import { mintPlot } from "TODO";
 * 
 * const transaction = mintPlot({
 *  x: ...,
 *  y: ...,
 *  fullURI: ...,
 * });
